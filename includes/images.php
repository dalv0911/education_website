<?php
   function process_images_upload(array $file,$size){
         ############ Configuration ##############
      $thumb_square_size      = $size; //Thumbnails will be cropped to 200x200 pixels
      $max_image_size      = 500; //Maximum image size (height and width)
      $thumb_prefix        = "thumb_"; //Normal thumb Prefix
      $destination_folder     = 'upload/avatar/'; //upload directory ends with / (slash)
   ...
   // =============== Upload Image Class ===========
   function process_images_class(array $file,$size){
         ############ Configuration ##############
      $thumb_square_size      = $size; //Thumbnails will be cropped to 200x200 pixels
      $max_image_size      = 500; //Maximum image size (height and width)
      $thumb_prefix        = "thumb_"; //Normal thumb Prefix
      $destination_folder     = 'upload/class/'; //upload directory ends with / (slash)
      $jpeg_quality        = 90; //jpeg quality
      ##########################################
         // check $_FILES['ImageFile'] not empty
         if(!isset($file) || !is_uploaded_file($file['tmp_name'])){
